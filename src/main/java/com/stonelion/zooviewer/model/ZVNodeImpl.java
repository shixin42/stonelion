...
package com.stonelion.zooviewer.model;
...
public class ZVNodeImpl implements ZVNode {
    ...
    public String toString() {
        return String.format("ZVNodeImpl[path='%s', " + this.exists + ", length='%d']", this.path,
    ...
    private static Stat copyStat(Stat stat) {
        return new Stat(stat.getCzxid(), stat.getMzxid(), stat.getCtime(), stat.getMtime(), stat.getVersion(), stat
                .getCversion(), stat.getAversion(), stat.getEphemeralOwner(), stat.getDataLength(), stat
